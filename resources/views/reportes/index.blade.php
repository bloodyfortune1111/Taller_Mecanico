                    ...
                    <div class="p-6">
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('reportes.servicios-solicitados') }}" 
                               class="flex-1 bg-green-500 hover:bg-green-600 text-white text-center py-2 px-4 rounded-lg font-medium transition-colors duration-200">
                                Ver Reporte
                            </a>
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center">
                                <div class="p-3 bg-yellow-100 rounded-xl mr-4">
                                    <i class="fas fa-chart-line text-yellow-600 text-xl"
                                    style="background-color: #FBBF24 !important;"></i>
                                </div>
                                <div>
