    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="dropdown-user-button inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md transition ease-in-out duration-150">
                            ...
                            <div class="ms-1">
                                <svg class="fill-current h-4 w-4 text-black transition-transform duration-300 dropdown-arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-black dark:text-white hover:text-white dark:hover:text-white hover:bg-white dark:hover:bg-gray-900 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-900 focus:text-gray-500 dark:focus:text-gray-400 transition duration-150 ease-in-out">
