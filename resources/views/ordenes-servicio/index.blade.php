            ...
            <div class="card fade-in">
                <div class="card-header">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('ordenes-servicio.create') }}" class="btn btn-primary">
                                ...
                                <tbody class="table-body">
                                    @foreach ($ordenesServicio as $orden)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex items-center gap-2">
                                                    <a href="{{ route('ordenes-servicio.show', ['orden_servicio' => $orden->id]) }}" class="btn btn-secondary" style="padding: 8px 12px; font-size: 0.75rem;">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                                        </svg>
                                                    </a>
                                                    <a href="{{ route('ordenes-servicio.edit', ['orden_servicio' => $orden->id]) }}" class="btn btn-warning" style="padding: 8px 12px; font-size: 0.75rem;">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                        </svg>
                                                    </a>
                                                    <form action="{{ route('ordenes-servicio.destroy', ['orden_servicio' => $orden->id]) }}" method="POST" class="inline">
                                                        @csrf
                                                        @method('DELETE')
