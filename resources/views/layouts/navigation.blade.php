<nav x-data="{ open: false }" class="bg-white border-b border-gray-200 shadow-sm navbar-container">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto navigation-spacing">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" 
                                class="flex items-center space-x-2 px-3 py-2 nav-item">
