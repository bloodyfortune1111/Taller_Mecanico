        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600">Registra un nuevo vehículo en el sistema</p>
                </div>
            </div>
        </div>
    </x-slot>
                ...
                <div class="card-header">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="card-subtitle">Complete la información del vehículo</p>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('vehiculos.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="form-group">
                                ...
                                <select name="cliente_id" id="cliente_id" class="form-select @error('cliente_id') border-red-500 @enderror">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="marca" id="marca" value="{{ old('marca') }}" 
                                       class="form-input @error('marca') border-red-500 @enderror"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="modelo" id="modelo" value="{{ old('modelo') }}" 
                                       class="form-input @error('modelo') border-red-500 @enderror"
                                       placeholder="Ej: Corolla, Focus, Aveo">
                                @error('modelo')
                                    <p class="text-red-500 text-sm mt-2 flex items-center">
                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="año" id="año" value="{{ old('año') }}" 
                                       min="1900" max="{{ date('Y') + 1 }}" 
                                       class="form-input @error('año') border-red-500 @enderror"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="matricula" id="matricula" value="{{ old('matricula') }}" 
                                       class="form-input @error('matricula') border-red-500 @enderror"
                                       placeholder="Ej: ABC-123-D, 123-ABC"
                            ...
                            <div class="form-group">
                                <label for="color" class="form-label">
                                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zM7 3H5v12a2 2 0 104 0V3z"></path>
                                    </svg>
                                    Color
                                </label>
                                <input type="text" name="color" id="color" value="{{ old('color') }}" 
                                       class="form-input @error('color') border-red-500 @enderror"
                            ...
                            <div class="form-group">
                                ...
                                <select name="combustible" id="combustible" class="form-select @error('combustible') border-red-500 @enderror">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="kilometraje" id="kilometraje" value="{{ old('kilometraje') }}" 
                                       min="0" class="form-input @error('kilometraje') border-red-500 @enderror"
