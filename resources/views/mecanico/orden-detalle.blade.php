    ...
    <div class="mb-8">
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-4">
                <li>
                    <div>
                        <a href="{{ route('mecanico.dashboard') }}" class="text-gray-800 hover:text-gray-600">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('mecanico.dashboard') }}" class="ml-4 text-sm font-medium text-gray-800 hover:text-gray-600">Mis Órdenes</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-4 text-sm font-medium text-gray-800">Orden #{{ $orden->id }}</span>
                    </div>
                </li>
            </ol>
        </nav>
