...
<div class="px-4 py-6 sm:px-0">
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Mi Panel de Trabajo</h1>
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">Total Asignadas</dt>
                            <dd class="text-lg font-medium text-gray-900">{{ $estadisticas['total_asignadas'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $estadisticas['finalizadas'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-md">
        <div class="px-4 py-5 sm:px-6">
            <h3 class="text-lg leading-6 font-medium text-gray-900">Mis Órdenes de Servicio</h3>
            <p class="mt-1 max-w-2xl text-sm text-gray-500">Órdenes asignadas a ti</p>
        </div>
                        ...
                        <div class="px-4 py-4 flex items-center justify-between hover:bg-gray-50">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    @if($orden->estado == 'recibido') bg-yellow-100 text-yellow-800
                                    @elseif($orden->estado == 'en_proceso') bg-orange-100 text-orange-800
                                ...
                                <!-- Botón de ver -->
                                <a href="{{ route('mecanico.orden', $orden->id) }}" 
        ...
        @else
            <div class="px-4 py-5 sm:px-6">
                <div class="text-center">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900">No hay órdenes asignadas</h3>
                    <p class="mt-1 text-sm text-gray-500">Actualmente no tienes órdenes de servicio asignadas.</p>
                </div>
            </div>
        @endif
    </div>
