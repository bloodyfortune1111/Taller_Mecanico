<x-app-layout>
    <x-slot name="header">
        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-lg shadow-md p-4 mx-6 header-container">
            ...
            <p class="text-white mt-1 text-sm" style="color: white !important;">Gestiona todos los servicios del taller mecánico</p>
        </div>
    </x-slot>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-md p-4 stats-card">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-semibold text-black">Total Servicios</h3>
                            <p class="text-xl font-bold text-black">{{ $servicios->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-lg shadow-md p-4 stats-card">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-semibold text-black">Servicios Activos</h3>
                            <p class="text-xl font-bold text-black">{{ $servicios->where('activo', true)->count() }}</p>
                        </div>
                    </div>
                </div>
